            ...
            public void onSuccess(Response response, String s) {
                ...
                try {
                    ...
                    if (!TextUtils.isEmpty(businessLicence)) {
                        ...
                        recyclerViewLicense.setAdapter(new CardAdapter(KndergardLoadingAcitivity.this, strings, "66", "license", "kinder"));
                    }
                    if (!TextUtils.isEmpty(environment)) {
                        String[] split = environment.split(";");
                        List<String> strings = Arrays.asList(split);
                        recyclerView.setAdapter(new BigCardAdapter(KndergardLoadingAcitivity.this, strings, 66));
                    }
