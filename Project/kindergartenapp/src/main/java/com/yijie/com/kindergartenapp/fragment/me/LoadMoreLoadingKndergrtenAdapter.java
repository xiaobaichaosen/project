...
import com.yijie.com.kindergartenapp.fragment.yijie.StudentBean;
...
public class LoadMoreLoadingKndergrtenAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public LoadMoreLoadingKndergrtenAdapter(List<StudentBean> dataList , Context context, int res) {
