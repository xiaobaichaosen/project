...
public class CertificateActivity extends BaseActivity implements ImagePickerAdapter.OnRecyclerViewItemClickListener{
        ...
        instance.post(Constant.SELECTBYCELLPHONE, map, new BaseCallback<String>() {
            ...
            public void onSuccess(Response response, String s) {
                ...
                try {
                    ...
                    //荣誉证书
                   String certificate = modityKindergartenDetail.getCertificate();
    ...
    public void onItemClick(View v, int position) {
        switch (position) {
            case IMAGE_ITEM_ADD:
                View view = LayoutInflater.from(CertificateActivity.this).inflate(R.layout.layout_popupwindow, null);
                ...
                View parent = LayoutInflater.from(CertificateActivity.this).inflate(R.layout.activity_main, null);
                ...
                btnPhoto.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        //打开选择,本次允许选择的数量
                        ImagePicker.getInstance().setSelectLimit(maxImgCount - selImageList.size());
                        Intent intent1 = new Intent(CertificateActivity.this, ImageGridActivity.class);
    ...
    public void uploadPicture(){
        ...
        HttpUtils.getinstance(this).uploadFiles("headload",Constant.HONORARYCCERTIFICATEUPLOADURL,stringStringHashMap,files, new BaseCallback<String>() {
            ...
            public void onSuccess(Response response, String s) throws JSONException {
                ...
                ShowToastUtils.showToastMsg(CertificateActivity.this,resMessage);
