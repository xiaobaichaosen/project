...
public class ProjectMemeryFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        tvContactProject.setVisibility(View.GONE);
                    ...
                    public void onClick(View view) {
                        ...
                        ViewUtils.alertTimerPicker(mActivity, yeartype, format, new ViewUtils.TimerPickerCallBack() {
                            ...
                            public void onTimeSelect(final String date) {
                                //设置推送tags
//                                setMemoryWarn(mList.get(position).getMemoContent().toString(),date,userId+"");
//                                        设置tag成功后，把tag传给后台
...
//                                tags.add(""+userId);
//
//                                JPushInterface.setTags(mActivity, tags, new TagAliasCallback() {
//                                    @Override
...
//                                });
     ...
     * @param userId
     */
    public void setMemoryWarn(String name, String time, String userId) {
