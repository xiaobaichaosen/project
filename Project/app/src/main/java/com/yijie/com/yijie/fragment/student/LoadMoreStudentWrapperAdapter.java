...
public class LoadMoreStudentWrapperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {



    private List<StudentBean> dataList;

    public LoadMoreStudentWrapperAdapter(List<StudentBean> dataList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof StudentRecyclerViewHolder) {
            ...
            if (type == 1) {
                studentRecyclerViewHolder.ivStutus.setBackgroundResource(R.mipmap.stuent_unabsorbed);
            } else if (type == 3) {
                studentRecyclerViewHolder.ivStutus.setBackgroundResource(R.mipmap.student_allowed);
            } else if (type == 4) {
                studentRecyclerViewHolder.ivStutus.setBackgroundResource(R.mipmap.student_noallowed);
            }
