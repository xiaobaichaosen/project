...
public class InternshipDatailActivity extends BaseActivity {
    @BindView(R.id.back)
    TextView back;
    @BindView(R.id.title)
    TextView title;
    ...
    public void setContentView() {
        setContentView(R.layout.activity_internshipdetails);
    }
...
actionItem.setBackgroundResource(R.mipmap.search);
        ...
        // 模拟获取数据
        getData();
        LoadMoreInternshipDatailAdapter loadMoreWrapperAdapter = new LoadMoreInternshipDatailAdapter(dataList,this);
        loadMoreWrapper = new LoadMoreWrapper(loadMoreWrapperAdapter);

        recyclerView.setAdapter(loadMoreWrapper);
        loadMoreWrapperAdapter.setOnItemClickListener(new LoadMoreInternshipDatailAdapter.OnItemClickListener(
            ...
            public void onLoadMore() {
                ...
                if (dataList.size() < 52) {
                    ...
                    new Timer().schedule(new TimerTask() {
                        @Override
                        public void run() {
                            InternshipDatailActivity.this.runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    getData();
