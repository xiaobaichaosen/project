...
public class NotPassActivity extends BaseActivity {
    @BindView(R.id.back)
    TextView back;
    @BindView(R.id.title)
    TextView title;
...
//                                                              intent.putExtra("isFromNoPass", 4);
//                                                              intent.setClass(NotPassActivity.this, StudentActivity.class);
//                                                              startActivity(intent);
    ...
    private void getData() {
        HttpUtils getinstance = HttpUtils.getinstance(NotPassActivity.this);
        HashMap<String, String> stringStringHashMap = new HashMap<>();
        stringStringHashMap.put("pageStart", currentPage + "");
        getinstance.post(Constant.SELECTRESUMENOTPASS, stringStringHashMap, new BaseCallback<String>() {
            @Override
