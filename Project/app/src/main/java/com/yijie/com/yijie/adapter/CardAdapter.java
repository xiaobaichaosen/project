...
public class CardAdapter extends RecyclerView.Adapter<CardAdapter.ViewHolder> {
    ...
    public CardAdapter(Context context,List<String> mList,int schoolId) {
...
//        holder.mImageView.setImageResource(mList.get(position));
        ...
        if (urlString.length()>0){
            //加载网络图片
            ImageLoaderUtil.getImageLoader(mContext).displayImage(Constant.getheadUrl+schoolId+"/summary/"+urlString, holder.mImageView, ImageLoaderUtil.getPhotoImageOption());
        }
        ...
        holder.mImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("imgUrl",Constant.getheadUrl+schoolId+"/summary/"+urlString);
