 ...
 *
 */
public class EveryStudentNineGridAdapter extends RecyclerView.Adapter<EveryStudentNineGridAdapter.ViewHolder> {

    private Context mContext;
    private List<NineGridTestModel> mList;
    protected LayoutInflater inflater;

    public EveryStudentNineGridAdapter(Context context) {
        mContext = context;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View convertView = inflater.inflate(R.layout.everystudentdetail_ninegrid_item, parent, false);
